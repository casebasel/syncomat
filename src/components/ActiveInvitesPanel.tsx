    ...
    <div className="flex items-center gap-3 px-3 py-2 rounded-lg border border-neutral-200 dark:border-neutral-800 bg-neutral-50/40 dark:bg-neutral-900/50 text-xs">
      ...
      <div className="min-w-0 flex-1">
        ...
        <p className="text-neutral-500 dark:text-neutral-400 text-[11px]">
          {invite.options.rw ? "RW" : "RO"} · {statusMeta(invite, status)}
        </p>
      </div>
      {isPending && (
        <button
          onClick={revoke}
          title="Widerrufen"
          className="p-1.5 rounded-md text-neutral-400 hover:text-rose-500 dark:hover:text-rose-400 hover:bg-rose-50 dark:hover:bg-rose-950/30"
        >
